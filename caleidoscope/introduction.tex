...
\sonia{No! the system for epistemic logic by Maffezioli, Naibo and Negri~\cite{maffezioli:etal:synthese13} is multi-conclusion}
\todo{need to say that it is the same principle as in their work, but we use in a more general setting and extend it to a framework for many intuitionistic modal logics while keeping the nice invertibility property.}
%

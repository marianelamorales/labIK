...
%\lutz{maybe the following goes to the ``extensions'' section. otherwise we have to define $\agklmn$ here}
...
%	\vlderivation{
%		\vlin{\rlabrn\IMP,\llabrn\AND}{}{\labels{x}{(\DIA(\BOX(a \OR b) \AND \DIA a) \AND \DIA(\BOX(a \OR b) \AND \DIA b)) \IMP \DIA(\DIA a \AND \DIA b)}}{
%			\vlin{\llabrn\DIA, \llabrn\AND,\llabrn\DIA, \rlabrn\DIA}{}{x\le x', \labels{x'}{\DIA(\BOX(a \OR b) \AND \DIA a)}, \labels{x'}{\DIA(\BOX(a \OR b) \AND \DIA b)} \SEQ \labels{x'}{\DIA(\DIA a \AND \DIA b)}}{
%				\vlin{g 1111}{}{x\le x', x'Ry', y'Ru', x'Rz', z'Rv', \labels{y'}{\BOX(a \OR b)}, \labels{u'}{a}, \labels{z'}{\BOX(a \OR b)}, \labels{v'}{b} \SEQ \labels{x'}{\DIA(\DIA a \AND \DIA b)}, \labels{y'}{\DIA a \AND \DIA b}, \labels{z'}{\DIA a \AND \DIA b}}{
%					\vlin{\llabrn\BOX}{}{y'Ru', z'Rv', z'\le z'', y'\le y'', y'Rv'', z''Rv'', z'Ru'', y''Ru'', \labels{y'}{\BOX(a \OR b)}, \labels{u'}{a}, \labels{z'}{\BOX(a \OR b)}, \labels{v'}{b} \SEQ \labels{y'}{\DIA a \AND \DIA b}, \labels{z'}{\DIA a \AND \DIA b}}{
%						\vlhy{y'Ru', z'Rv', z'\le z'', y'\le y'', y'Rv'', z''Rv'', z'Ru'', y''Ru'', \labels{u'}{a \OR b}, \labels{v''}{a \OR b}, \labels{u'}{a}, \labels{v'}{a \OR b}, \labels{u''}{a \OR b},\labels{v'}{b} \SEQ \labels{y'}{\DIA a \AND \DIA b}, \labels{z'}{\DIA a \AND \DIA b}}
%%						\vlhtr{\pi_1}{\wbri{u}{\lef{\BOX(a \OR b)}, \wbri{x}{\lef a}, \wbri{z}{\lef a}}, \wbri{v}{\lef{\BOX(a \OR b)}, \wbri{y}{\lef b}, \wbri{z}{}}, \rig{\DIA(\DIA a \AND \DIA b)}}
%%					}
%%					{
%%						\vlhtr{\pi_2}{\wbri{u}{\lef{\BOX(a \OR b)}, \wbri{x}{\lef a}, \wbri{z}{\lef b}}, \wbri{v}{\lef{\BOX(a \OR b)}, \wbri{y}{\lef b}, \wbri{z}{}}, \rig{\DIA(\DIA a \AND \DIA b)}}	

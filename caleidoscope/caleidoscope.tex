...
\sonia{The idea of this section is to show the things that our system could do (extensions of the logic) and Simpson could not.}

\sonia{Scott-Lemmon with the new rules (general rules for F2, F1, etc) for the system and the lemma that shows that each rule is admissible}

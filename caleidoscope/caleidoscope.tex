...
\begin{figure}%[h]
	...
	\begin{tabular}{@{\!}c@{\quad}c}
		...
		\\\\
		\multicolumn{2}{c}{
 		$\vliinf{\llabrn\IMP}{}{\B, x \le y, \Left, \labels{x}{A} \IMP B \SEQ \Right}{\B, x \le y, \Left \SEQ \Right, \labels{y}{A}}{\B, x \le y, \Left, \labels{y}{B} \SEQ \Right}$ 
...
\begin{center}
	...
	$\vliinf{\sil}{}{\B, \Left, x \le y, x \colon A \IMP B \Rightarrow \Right}{\B, \Left, x \le y, x \colon A \IMP B \Rightarrow \Right, y \colon A}{\B, \Left, x \le y, x \colon A \IMP B, y \colon B \Rightarrow \Right}$
\end{center}

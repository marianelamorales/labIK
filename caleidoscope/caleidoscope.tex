...
%	\begin{minipage}{.95\textwidth}
	\begin{tabular}{c@{\quad}c}
		...
		\\\\
		\multicolumn{2}{c}{
		$\vlinf{\rlabrn\IMP}{\text{\scriptsize $y$ fresh}}{\B, \Left \SEQ \Right, \labels{x}{A \IMP B}}{\B, \futs xy, \Left, \labels{y}{A} \SEQ \Right, \labels{y}{B}}$
		}
		\\\\
		\multicolumn{2}{c}{
...
% 		&$\vliinf{\rlabrn\IMP}{\text{\scriptsize $x \le y \in \B$}}{\B, \Left, \labels{x}{A \IMP B} \SEQ \Right}{\B, \Left \SEQ \Right, \labels{y}{A}}{\B, \Left, \labels{y}{B} \SEQ \Right}$
		...
		&
		$\vlinf{\rlabrn\BOX}{\text{\scriptsize $y, z$ fresh}}{\B, \Left \SEQ \Right, \labels{x}{\BOX A}}{\B, \futs xy, \accs yz, \Left \SEQ \Right, \labels{z}{A}}$
		\\\\
		$\vlinf{\llabrn\DIA}{\text{\scriptsize $y$ fresh}}{\B, \Left, \labels{x}{\DIA A} \SEQ \Right}{\B, \accs xy, \Left, \labels{y}{A} \SEQ \Right}$
		&
	...
	\begin{smallequation*}
		\vlderivation{
			\vlin{\llabrn\DIA}{}{\B, \futs xy; \Left, \labels{x}{\DIA A} \SEQ \Right, \labels{y}{\DIA A}}{
				\vlin{\rn{F_2}}{}{\B, \futs xy, \accs xz, \Left, \labels{z}{A} \SEQ \Right, \labels{y}{\DIA A}}{
...
\begin{proof}[Proof of Theorem~\ref{thm:completeness}]
  ...
  \item $\kax[1]$:
    ...
    \vlderivation{
				...
				{\vlin {\rlabrn{\IMP}}
					{\lb z \mbox{ fresh}}
					{\futs xy, \labels{y}{\BOX(A \IMP B)} \Rightarrow \labels{y}{\BOX A \IMP \BOX B}}
					{\vlin {\rlabrn{\BOX}}
						{\lb w, \lb u \mbox{ fresh}}
						{\futs xy, \futs yz, \labels{y}{\BOX(A \IMP B)}, \labels{z}{\BOX A} \Rightarrow \labels{z}{\BOX B}}
						{\vlin {\llabrn{\BOX}}
							{}
							{\futs xy, \futs yz, \futs zw, \accs wu, \labels{y}{\BOX(A \IMP B)}, \labels{z}{\BOX A} \Rightarrow \labels{u}{B}}
							{\vlin {\color{red}\rn{trans}}
								{}
								{\futs xy, \futs yz, \futs zw, \accs wu, \labels{y}{\BOX(A \IMP B)}, \labels{z}{\BOX A}, \labels{u}{A} \Rightarrow \labels{u}{B}}
								{\vlin {\llabrn{\BOX}}
									{}
									{\futs xy, \futs yz, \futs zw, \futs yw, \accs wu, \labels{y}{\BOX(A \IMP B)}, \labels{z}{\BOX A}, \labels{u}{A} \Rightarrow \labels{u}{B}}
									{\vlin {\color{red}\rn{refl}}
										{}
										{\futs xy, \futs yz, \futs zw, \futs yw, \accs wu, \labels{y}{\BOX(A \IMP B)}, \labels{z}{\BOX A}, \labels{u}{A}, \labels{u}{A \IMP B} \Rightarrow \labels{u}{B}}
										{\vliin{\llabrn{\IMP}}
											{}
											{\futs xy, \futs yz, \futs zw, \futs yw, \futs uu, \accs wu, \labels{y}{\BOX(A \IMP B)}, \labels{z}{\BOX A}, \labels{u}{A}, \labels{u}{A \IMP B} \Rightarrow \labels{u}{B}}
											{\vlin {\rn{id}}
												{}
												{\B, \labels{y}{\BOX(A \IMP B)}, \labels{z}{\BOX A}, \labels{u}{A}, \labels{u}{A \IMP B} \Rightarrow \labels{u}{B}, \labels{u}{A}}
												{\vlhy {}}}
											{\vlin {\rn{id}}
												{}
												{\B, \labels{y}{\BOX(A \IMP B)}, \labels{z}{\BOX A}, \labels{u}{A}, \labels{u}{A \IMP B}, \labels{u}{B} \Rightarrow \labels{u}{B}}
												{\vlhy {}}}}}}}}}}
    }
    $$
  ...
  \item $\kax[2]$:
    ...
    \vlderivation {
		...
		{\vlin {\rlabrn{\IMP}}
			{\lb z \mbox{ fresh}}
			{ \futs xy, \labels{y}{\BOX (A \IMP B)} \Rightarrow \labels{y}{(\DIA A \IMP \DIA B)}}
			{\vlin {\llabrn{\DIA}}
				{\lb u \mbox{ fresh}}
				{\futs xy, \futs yz, \labels{y}{\BOX (A \IMP B)}, \labels{z}{\DIA A} \Rightarrow \labels{z}{\DIA B}}
				{\vlin{\rlabrn{\DIA}}
					{}
					{\futs xy, \futs yz, \accs zu, \labels{y}{\BOX (A \IMP B)}, \labels{u}{A} \Rightarrow \labels{z}{\DIA B}}
					{\vlin {\llabrn{\BOX}}
						{}
						{\futs xy, \futs yz, \accs zu, \labels{y}{\BOX (A \IMP B)}, \labels{u}{A} \Rightarrow \labels{z}{\DIA B}, \labels{u}{B}}
						{\vlin {\color{red}\rn{refl}}
							{}
							{\futs xy, \futs yz, \accs zu, \labels{y}{\BOX (A \IMP B)}, \labels{u}{A}, \labels{u}{A \IMP B} \Rightarrow \labels{z}{\DIA B}, \labels{u}{B}}
							{\vliin{\llabrn{\IMP}}
								{}
								{\futs xy, \futs yz, \accs zu, \futs uu, \labels{y}{\BOX (A \IMP B)}, \labels{u}{A}, \labels{u}{A \IMP B} \Rightarrow \labels{z}{\DIA B}, \labels{u}{B}}
								{\vlin {\rn{id}}
									{}
									{\B, \labels{y}{\BOX (A \IMP B)}, \labels{u}{A}, \labels{u}{A \IMP B} \Rightarrow \labels{z}{\DIA B}, \labels{u}{B}, \labels{u}{A}}
									{\vlhy {}}}
								{\vlin {\rn{id}}
									{}
									{\B, \labels{y}{\BOX (A \IMP B)}, \labels{u}{A}, \labels{u}{A \IMP B}, \labels{u}{B} \Rightarrow \labels{z}{\DIA B}, \labels{u}{B}}
									{\vlhy {}}}								}}}}}}
    }
    $$
...
\vlderivation {
		...
		{\vlin {\rlabrn{\BOX}}
			...
			{\futs xy, \labels{y}{\DIA A \IMP \BOX B} \Rightarrow \labels{y}{\BOX (A \IMP B)}}
			{\vlin {\rlabrn{\IMP}}
				{\lb u \mbox{ fresh}}
				{\futs xy, \futs yz, \accs zw, \labels{y}{\DIA A \IMP \BOX B} \Rightarrow \labels{w}{A \IMP B}}
				{\vlin {\color{red}{\rn{F_1}}}
					{}
					{\futs xy, \futs yz, \futs wu, \accs zw, \labels{y}{\DIA A \IMP \BOX B}, \labels{u}{A} \Rightarrow \labels{u}{B}}
					{\vlin {\color{red}\rn{trans}}
						{}
						{\futs xy, \futs yz, \futs wu, \futs zt, \accs zw, \accs tu, \labels{y}{\DIA A \IMP \BOX B}, \labels{u}{A} \Rightarrow \labels{u}{B}}
						{\vliin {\llabrn{\IMP}}
							{}
							{\futs xy, \futs yz, \futs wu, \futs zt, \futs yt, \accs zw, \accs tu, \labels{y}{\DIA A \IMP \BOX B}, \labels{u}{A} \Rightarrow \labels{u}{B}}
							{\vlin {\rlabrn{\DIA}}
									{}
									{\B, \labels{y}{\DIA A \IMP \BOX B}, \labels{u}{A} \Rightarrow \labels{u}{B}, \labels{t}{\DIA A}}
									{\vlin {\color{red}\rn{refl}}
										{}
										{\B, \labels{y}{\DIA A \IMP \BOX B}, \labels{u}{A} \Rightarrow \labels{u}{B}, \labels{t}{\DIA A}, \labels{u}{A}}
										{\vlin {\rn{id}}
											{}
											{\B, \futs uu,  \labels{y}{\DIA A \IMP \BOX B}, \labels{u}{A} \Rightarrow \labels{u}{B}, \labels{t}{\DIA A}, \labels{u}{A}}
											{\vlhy {}}}}}
							{\vlin {\color{red}\rn{refl}}
								{}
								{\B, \labels{y}{\DIA A \IMP \BOX B}, \labels{u}{A}, \labels{t}{\BOX B} \Rightarrow \labels{u}{B}}
								{\vlin {\llabrn{\BOX}}
									{}
									{\B, \futs tt, \labels{y}{\DIA A \IMP \BOX B}, \labels{u}{A}, \labels{t}{\BOX B} \Rightarrow \labels{u}{B}}
									{\vlin {\color{red}\rn{refl}}
										{}
										{\B, \futs tt, \labels{y}{\DIA A \IMP \BOX B}, \labels{u}{A}, \labels{t}{\BOX B}, \labels{u}{B} \Rightarrow \labels{u}{B}}
										{\vlin {\rn{id}}
											{}
											{\B, \futs tt, \futs uu, \labels{y}{\DIA A \IMP \BOX B}, \labels{u}{A}, \labels{t}{\BOX B}, \labels{u}{B} \Rightarrow \labels{u}{B}}
											{\vlhy {}}}}}}}}}}}
}
$$
...
\item $\kax[5]$:
  ...
  is standard using the cut rule and for necesitation, we can
...
\todo{use the macro for sequents (the macro uses a longer arrow)}
...
of our system $\labIKp$ is sound. We want to prove that for all model
$\M$ that satisfies the premise, then $\M$ satifies the conclusion.
...
\begin{itemize}
	...
	\begin{center}
		\emph{For all model $\M$, if $\M \Vdash \B,\Left, \futs xy, \accs yz, \labels{x}{\BOX A}, \labels{z}{A} \Rightarrow \Right$, then $\M \Vdash \B, \Left, \futs xy, \accs yz, \labels{x}{\BOX A} \Rightarrow \Right$.}
	\end{center}
	
	By way of contradiction, we assume that there exists a model $\M_{0}$ such that $\M_{0} \not \Vdash \B, x \le y, yRz,\Left,\break \labels{x}{\BOX A} \Rightarrow \Right$, i.e $\M_{0} \Vdash \B$, $\M_{0} \Vdash \Left$, $\M_{0} \Vdash \futs xy$, $ \M_{0} \Vdash \accs yz$, $\M_{0} \Vdash \labels{x}{\BOX A}$ and  $\M_{0} \not \Vdash \Right$. Therefore, in particular from $\M_{0} \Vdash \labels{x}{\BOX A}$ we have that for all $y, z \in W$ such that $\futs xy$ and $\accs yz$, then $\M_{0}, f(\lb z) \Vdash \fm A$, i.e $\M_{0} \Vdash \labels{z}{\fm A}$. 

\marianela{working on this}
	\marianela{
...
The \emph{height} of a derivation $\DD$, denoted by $\height\DD$, is \todo{finish}

We say that a rule is \emph{height-preserving admissible} if for every derivation $\DD$ of its premise there is a derivation $\DD'$ of its conclusion such that $\height{\DD'}\le\height\DD$. A rule is \emph{height-preserving invertible} if \todo{...}
...
\begin{lemma}
  ...
  $$
  \vlinf{\labrn{mon_a}}{}{\lseq{\B, x \le x'}{\Left, \labels{x}{a}}\Right}{
    \lseq{\B, x \le x'}{\Left, \labels{x}{a}, \labels{x'}{a}}\Right}
  $$
  is height-preserving admissible for $\labIKp$.
\end{lemma}
	...
	\begin{center}
		\scalebox{0.93}{
			$\vlderivation {\vlin {\sir}
				{y$ fresh$}
				{\Rightarrow \labels{x}{\DIA \BOX A \IMP \BOX \DIA A}}
				{\vlin {\sbr}
					{z, w $ fresh $}
					{x \le y, \labels{y}{\DIA \BOX A} \Rightarrow \labels{y}{\BOX \DIA A}}
					{\vlin {\sdl}
						{u$ fresh$}
						{x \le y, y \le z, zRw, \labels{y}{\DIA \BOX A} \Rightarrow \labels{w}{\DIA A}}
						{\vlin {\ftwo}
							{t$ fresh$}
							{x \le y, y \le z, zRw, yRu, \labels{u}{\BOX A} \Rightarrow \labels{w}{\DIA A}}
							{\vlin {\gklmn}
								{t', j$ fresh$}
								{x \le y, y \le z, u \le t, zRw, yRu, zRt, \labels{u}{\BOX A} \Rightarrow \labels{w}{\DIA A}}
								{\vlin {\sdr}
									{}
									{x \le y, y \le z, u \le t, t \le t', zRw, yRu, zRt, t'Rj, wRj, \labels{u}{\BOX A} \Rightarrow \labels{w}{\DIA A}}
									{\vlin {\trans}
										{}
										{x \le y, y \le z, u \le t, t \le t', zRw, yRu, zRt, t'Rj, wRj, \labels{u}{\BOX A} \Rightarrow \labels{w}{\DIA A}, \labels{j}{A}}
										{\vlin {\sbl}
											{}
											{x \le y, y \le z, u \le t, t \le t', u \le t', zRw, yRu, zRt, t'Rj, wRj, \labels{u}{\BOX A} \Rightarrow \labels{w}{\DIA A}, \labels{j}{A}}
											{\vlin {\refl}
												{}
												{x \le y, y \le z, u \le t, t \le t', u \le t', zRw, yRu, zRt, t'Rj, wRj, \labels{u}{\BOX A}, \labels{j}{A} \Rightarrow \labels{w}{\DIA A}, \labels{j}{A}}
												{\vlin {\ids}
													{}
													{x \le y, y \le z, u \le t, t \le t', u \le t',j \le j, zRw, yRu, zRt, t'Rj, wRj, \labels{u}{\BOX A}, \labels{j}{A} \Rightarrow \labels{w}{\DIA A}, \labels{j}{A}}
													{\vlhy {}}}}}}}}}}}}$}
	\end{center}
\end{proof}

...
We write $\M, \lb w \Vdash a$ if $a \in V(w)$, and by definition, we always have $\M, w \Vdash \top$ and never that $\M, w \Vdash \bot$. 
%
...
%\marianela{maybe adding the following: ?}
%Now, we would like to consider special restrictions on these bi-relational frames. For example, we would be interested in having a correspondence between the logic $\IK$ extended with some variants of axioms and bi-relational frames satisfyins the corresponding d
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%
...
\begin{proof}
	...
	\begin{itemize}
		...
		\begin{smallequation*}
			%\vlinf{\labrn{id_g}}{}{\B, x \le y; \Left, \labels{x}{a} \SEQ \Right, \labels{y}{a}}{}
			%\reducesto
			\vlinf{\labrn{id}}{}{\B, x \le y; \Left, \labels{x}{a} \SEQ \Right, \labels{y}{a}}{}
		\end{smallequation*}
		...
		\begin{smallequation*}
			\vlderivation{
				\vlin{\llabrn\AND}{}{\B, x \le y; \Left, \labels{x}{A \AND B} \SEQ \Right, \labels{y}{A \AND B}}{
					\vliin{\rlabrn\AND}{}{\B, x \le y; \Left, \labels{x}{A}, \labels{x}{B} \SEQ \Right, \labels{y}{A \AND B}}{
						\vlin{\labrn{id_g}}{}{\B, x \le y; \Left, \labels{x}{A}, \labels{x}{B} \SEQ \Right, \labels{y}{A}}{
							\vlhy{}
						}
					}{
					\vlin{\labrn{id_g}}{}{\B, x \le y; \Left, \labels{x}{A}, \labels{x}{B} \SEQ \Right, \labels{y}{B}}{
						\vlhy{}
					}
				}
			}
	...
	\begin{smallequation*}
		\vlderivation{
			\vliin{\llabrn\OR}{}{\B, x \le y; \Left, \labels{x}{A \OR B} \SEQ \Right, \labels{y}{A \OR B}}{
				\vlin{\rlabrn\OR}{}{\B, x \le y; \Left, \labels{x}{A} \SEQ \Right, \labels{y}{A \OR B}}{
					\vlin{\labrn{id_g}}{}{\B, x \le y; \Left, \labels{x}{A} \SEQ \Right, \labels{y}{A}}{
						\vlhy{}
					}
				}
			}{
			\vlin{\rlabrn\OR}{}{\B, x \le y; \Left, \labels{x}{B} \SEQ \Right, \labels{y}{A \OR B}}{
				\vlin{\labrn{id_g}}{}{\B, x \le y; \Left, \labels{x}{B} \SEQ \Right, \labels{y}{B}}{
					\vlhy{}
				}
			}
		}
...
%	\end{smallequation*}
	\begin{smallequation*}
		\vlderivation{
			\vlin{\rlabrn\IMP}{}{\B, x \le y; \Left, \labels{x}{A \IMP B} \SEQ \Right, \labels{y}{A \IMP B}}{
				\vlin{\rn{trans}}{}{\B, x \le y, y \le z; \Left, \labels{x}{A \IMP B}, \labels{z}{A} \SEQ \Right, \labels{z}{B}}{
					\vliin{\llabrn\IMP}{}{\B, x \le y, y \le z, x \le z; \Left, \labels{x}{A \IMP B}, \labels{z}{A} \SEQ \Right, \labels{z}{B}}{
						\vlin{\rn{refl}}{}{\B, x \le y, y \le z, x \le z; \Left, \labels{x}{A \IMP B}, \labels{z}{A} \SEQ \Right, \labels{z}{B}, \labels{z}{A}}{
							\vlin{\labrn{id_g}}{}{\B, x \le y, y \le z, x \le z, z \le z; \Left, \labels{x}{A \IMP B}, \labels{z}{A} \SEQ \Right, \labels{z}{B}, \labels{z}{A}}{
								\vlhy{}
							}
						}
					}{
					\vlin{\rn{refl}}{}{\B, x \le y, y \le z, x \le z; \Left, \labels{z}{B}, \labels{z}{A} \SEQ \Right, \labels{z}{B}}{
						\vlin{\labrn{id_g}}{}{\B, x \le y, y \le z, x \le z, z \le z; \Left, \labels{z}{B}, \labels{z}{A} \SEQ \Right, \labels{z}{B}}{
							\vlhy{}
						}
					}
				}
...
%	\end{smallequation*}
	\begin{smallequation*}
		\vlderivation{
			\vlin{\rlabrn\BOX}{}{\B, x \le y; \Left, \labels{x}{\BOX A} \SEQ \Right, \labels{y}{\BOX A}}{
				\vlin{\rn{trans}}{}{\B, x \le y, y \le z, z \rel w; \Left, \labels{x}{\BOX A} \SEQ \Right, \labels{w}{A}}{
					\vlin{\llabrn\BOX}{}{\B, x \le y, y \le z, x \le z, z \rel w; \Left, \labels{x}{\BOX A} \SEQ \Right, \labels{w}{A}}{
						\vlin{\rn{refl}}{}{\B, x \le y, y \le z, x \le z, z \rel w; \Left, \labels{z}{\BOX A}, \labels{w}{A} \SEQ \Right, \labels{w}{A}}{
							\vlin{\labrn{id_g}}{}{\B, x \le y, y \le z, x \le z, z \rel w, w \le w; \Left, \labels{z}{\BOX A}, \labels{w}{A} \SEQ \Right, \labels{w}{A}}{
								\vlhy{}
							}
						}
					}
...
\begin{definition}
	Let $\M = \langle W, \rel, \le, V \rangle$ be a model and $\B, \Gamma \Rightarrow \Delta$ a sequent. We say that $\M \Vdash \B, \Gamma \Rightarrow \Delta$ if there exists $\f$ such that:
	\begin{enumerate}

...
sequents~\cite{kashima,brunnler,pog} or 2-sequents~\cite{masini:apal92},
...
$\Delta$ for sets of labelled formulas.
...
\parbox{30em}{%
	...
	$w \Vdash \BOX A$ iff for all $\lb{w'}$ and $\lb u$ with $\futs w{w'}$ and $\accs {w'}u$, $u \Vdash A$ \hfill %$(\ast)$
...
\begin{proof}
	By induction of the size of the formula $A$.
	\begin{smallequation*}
		\vlinf{\labrn{id_g}}{}{\B, x \le y; \Left, \labels{x}{a} \SEQ \Right, \labels{y}{a}}{}
		\reducesto
...
\begin{smallequation*}\hspace*{-10em}
	\vlderivation{
		\vlin{\rlabrn\IMP}{}{\B, x \le y; \Left, \labels{x}{A \IMP B} \SEQ \Right, \labels{y}{A \IMP B}}{
			\vlin{trans}{}{\B, x \le y, y \le z; \Left, \labels{x}{A \IMP B}, \labels{z}{A} \SEQ \Right, \labels{z}{B}}{
				\vliin{\llabrn\IMP}{}{\B, x \le y, y \le z, x \le z; \Left, \labels{x}{A \IMP B}, \labels{z}{A} \SEQ \Right, \labels{z}{B}}{
					\vlin{refl}{}{\B, x \le y, y \le z, x \le z; \Left, \labels{x}{A \IMP B}, \labels{z}{A} \SEQ \Right, \labels{z}{B}, \labels{z}{A}}{
						\vlin{\labrn{id_g}}{}{\B, x \le y, y \le z, x \le z, z \le z; \Left, \labels{x}{A \IMP B}, \labels{z}{A} \SEQ \Right, \labels{z}{B}, \labels{z}{A}}{
							\vlhy{}
						}
					}
				}{
				\vlin{refl}{}{\B, x \le y, y \le z, x \le z; \Left, \labels{z}{B}, \labels{z}{A} \SEQ \Right, \labels{z}{B}}{
...
\begin{smallequation*}
	\vlderivation{
		\vlin{\rlabrn\BOX}{}{\B, x \le y; \Left, \labels{x}{\BOX A} \SEQ \Right, \labels{y}{\BOX A}}{
			\vlin{trans}{}{\B, x \le y, y \le z, z \rel w; \Left, \labels{x}{\BOX A} \SEQ \Right, \labels{w}{A}}{
				\vlin{\llabrn\BOX}{}{\B, x \le y, y \le z, x \le z, z \rel w; \Left, \labels{x}{\BOX A} \SEQ \Right, \labels{w}{A}}{
					\vlin{refl}{}{\B, x \le y, y \le z, x \le z, z \rel w; \Left, \labels{z}{\BOX A}, \labels{w}{A} \SEQ \Right, \labels{w}{A}}{
...
\begin{smallequation*}
	\vlderivation{
		\vlin{\llabrn\DIA}{}{\B, x \le y; \Left, \labels{x}{\DIA A} \SEQ \Right, \labels{y}{\DIA A}}{
			\vlin{\color{red}{F_2}}{}{\B, x \le y, x \rel z; \Left, \labels{z}{A} \SEQ \Right, \labels{y}{\DIA A}}{

...
labelled calculi have the advantage of being more uniform and
accommodating more logics.

Standard labelled sequent calculi attach to every formula $\fm A$ a label
...
We write $\M, \lb w \Vdash \fm a$ if $\fm a \in V(\lb w)$, and by definition, we always have $\M, \lb w \Vdash \top$ and never that $\M, \lb w \Vdash \bot$. 
%
...
instead of using the rules in~\eqref{eq:nomon}. We prove the admissibility of monotonicity in the Section~\ref{sec:cut-elim}.
...
\begin{proof}
	By induction of the size of the formula $\fm A$.
	\begin{itemize}
		\item Atomic case
		\begin{smallequation*}
								...
								{\vlin {\llabrn{\BOX}}
									...
									{\vlin {\color{red}\rn{refl}}
										...
										{\vliin{\llabrn{\IMP}}
											...
											{\vlin {\rn{id}}
												{}
												{G, \labels{y}{\BOX(A \IMP B)}, \labels{z}{\BOX A}, \labels{u}{A}, \labels{u}{A \IMP B} \Rightarrow \labels{u}{B}, \labels{u}{A}}
												{\vlhy {}}}
											{\vlin {\rn{id}}
												{}
												{G, \labels{y}{\BOX(A \IMP B)}, \labels{z}{\BOX A}, \labels{u}{A}, \labels{u}{A \IMP B}, \labels{u}{B} \Rightarrow \labels{u}{B}}
												{\vlhy {}}}}}}}}}}
			}$
		\end{center}
		
		where $G$ is equal to: $\futs xy, \futs yz, \futs zw, \futs yw, \futs uu, \accs wu$.
					...
					{\vlin {\llabrn{\BOX}}
						...
						{\vlin {\color{red}\rn{refl}}
							...
							{\vliin{\llabrn{\IMP}}
								...
								{\vlin {\rn{id}}
									{}
									{T, \labels{y}{\BOX (A \IMP B)}, \labels{u}{A}, \labels{u}{A \IMP B} \Rightarrow \labels{z}{\DIA B}, \labels{u}{B}, \labels{u}{A}}
									{\vlhy {}}}
								{\vlin {\rn{id}}
									{}
									{T, \labels{y}{\BOX (A \IMP B)}, \labels{u}{A}, \labels{u}{A \IMP B}, \labels{u}{B} \Rightarrow \labels{z}{\DIA B}, \labels{u}{B}}
									{\vlhy {}}}								}}}}}}
	}$
\end{center}

where $T$ is equal to $\futs xy, \futs yz, \accs zu, \futs uu$.
...
\begin{center}
	...
	\vlderivation{
		\vlin{\llabrn{\IMP}}{}{\circledast}{\vlin {\rlabrn{\DIA}}
			{}
			{\futs xy, \futs yz, \futs wu, \futs zt, \futs yt, \accs zw, \accs tu, \labels{y}{\DIA A \IMP \BOX B}, \labels{u}{A} \Rightarrow \labels{u}{B}, \labels{t}{\DIA A}}
			{\vlin {\rn{refl}}
				{}
				{\futs xy, \futs yz, \futs wu, \futs zt, \futs yt, \accs zw, \accs tu, \labels{y}{\DIA A \IMP \BOX B}, \labels{u}{A} \Rightarrow \labels{u}{B}, \labels{t}{\DIA A}, \labels{u}{A}}
				{\vlin {\rn{id}}
					{}
					{\futs xy, \futs yz, \futs wu, \futs zt, \futs yt, \futs uu, \accs zw, \accs tu, \labels{y}{\DIA A \IMP \BOX B}, \labels{u}{A} \Rightarrow \labels{u}{B}, \labels{t}{\DIA A}, \labels{u}{A}}
					{\vlhy {}}}}}
	}$
\end{center}
...
Following the proof for the Theorem \ref{thm:cutfree-compl}, in this section, we prove the implication \ref{ii}$\implies$\ref{iii}, i.e, we want to prove that our system $\labIKp$ is complete without the \rn{cut} rule.
...
\begin{proof}[Proof of Theorem~\ref{thm:mon-adm}]
	...
	\todo{say that we can obtain the proof for monotonicity using the proof of cut.}

				...
				{\vlin {\color{red}{\rn{F_1}}}
					...
					{\vlin {\rn{trans}}
						...
						{\vliin {\llabrn{\IMP}}
							...
							{\vlin {\rlabrn{\DIA}}
									{}
									{R, \labels{y}{\DIA A \IMP \BOX B}, \labels{u}{A} \Rightarrow \labels{u}{B}, \labels{t}{\DIA A}}
									{\vlin {\rn{refl}}
										{}
										{R, \labels{y}{\DIA A \IMP \BOX B}, \labels{u}{A} \Rightarrow \labels{u}{B}, \labels{t}{\DIA A}, \labels{u}{A}}
										{\vlin {\rn{id}}
											{}
											{R, \futs uu,  \labels{y}{\DIA A \IMP \BOX B}, \labels{u}{A} \Rightarrow \labels{u}{B}, \labels{t}{\DIA A}, \labels{u}{A}}
											{\vlhy {}}}}}
							{\vlin {\rn{refl}}
								{}
								{R, \labels{y}{\DIA A \IMP \BOX B}, \labels{u}{A}, \labels{t}{\BOX B} \Rightarrow \labels{u}{B}}
								{\vlin {\llabrn{\BOX}}
									{}
									{R, \futs tt, \labels{y}{\DIA A \IMP \BOX B}, \labels{u}{A}, \labels{t}{\BOX B} \Rightarrow \labels{u}{B}}
									{\vlin {\rn{refl}}
										{}
										{R, \futs tt, \labels{y}{\DIA A \IMP \BOX B}, \labels{u}{A}, \labels{t}{\BOX B}, \labels{u}{B} \Rightarrow \labels{u}{B}}
										{\vlin {\rn{id}}
											{}
											{R, \futs tt, \futs uu, \labels{y}{\DIA A \IMP \BOX B}, \labels{u}{A}, \labels{t}{\BOX B}, \labels{u}{B} \Rightarrow \labels{u}{B}}
											{\vlhy {}}}}}}}}}}}
	}$
	
\end{center}

where $R$ is equal to $\futs xy, \futs yz, \futs wu, \futs zt, \futs yt, \accs zw, \accs tu$.

...
%	of a non-empty set of worlds $W$ equipped with two binary relations $R$ and $\le$, where $R$ being the modal \emph{accessibility relation} and $\le$ a preorder (\emph{i.e.} a reflexive and transitive relation), satisfying the following conditions:
	...
	\begin{enumerate}
		\item[(F1)] For $u, v, v' \in W$, if $u \rel v$ and $v \le v'$, there exists $u'$ s.t.~$u \le u'$ and $u' \rel v'$.
		
		\item[(F2)] For $u', u, v \in W$, if $u \le v$, there exists $v'$ s.t.~$u' \rel v'$ and $v\le v'$.
	\end{enumerate}
...
% 		}
		...
		&
		$\vlinf{\rlabrn\BOX}{\text{\scriptsize $y, z$ fresh}}{\G, \Left \Rightarrow \Right, x \colon \square A}{\G, \Left, x \le y, y \rel z \Rightarrow \Right, z \colon A}$
		\\\\
		$\vlinf{\llabrn\DIA}{\text{\scriptsize $y$ fresh}}{\G, \Left, x \colon \lozenge A \Rightarrow \Right}{\G, \Left, x \rel y, y \colon A \Rightarrow \Right}$
		&
		$\vlinf{\rlabrn\DIA}{}{\G, \Left, x \rel y \Rightarrow \Right, x \colon \lozenge A}{\G, \Left, x \rel y \Rightarrow \Right, x \colon \lozenge A, y \colon A}$
		\\
		\multicolumn{2}{c}{
...
\begin{definition}
A two-sided intuitionistic \emph{labelled sequents} would be of the form $\G, \Left \Rightarrow \Right$ where $\G$ denotes a set of relational atoms $x \rel y$ and preorder atoms $x \le y$, and $\Left$ and $\Right$ are multi-sets of labelled formulas $x \colon A$ (for $x$ and $y$ taken from the set of labels and $A$ an intuitionistic modal formula).
\end{definition}
...
%						\vlin {\refl}{}{x \le y, y \le z, w \le u, z \le t, y \le t, z \rel w, t \rel u, y \colon \lozenge A \SEQ \square B, u \colon A, t \colon \square B \Rightarrow u \colon B}{
%							\vlin {\sbl}{}{x \le y, y \le z, w \le u, z \le t, y \le t, t \le t, z \rel w, t \rel u, y \colon \lozenge A \SEQ \square B, u \colon A, t \colon \square B \Rightarrow u \colon B}{
%								\vlin {\refl}{}{x \le y, y \le z, w \le u, z \le t, y \le t, t \le t, z \rel w, t \rel u, y \colon \lozenge A \SEQ \square B, u \colon A, t \colon \square B, u \colon B \Rightarrow u \colon B}{
%									\vlin {\ids}{}{x \le y, y \le z, w \le u, z \le t, y \le t, t \le t, u \le u, z \rel w, t \rel u, y \colon \lozenge A \SEQ \square B, u \colon A, t \colon \square B, u \colon B \Rightarrow u \colon B}{
...
%\vspace{2mm}
%
% $\vlderivation {\vlinf{\bllab}{}{\G, x \rel y, \Left x \colon \square A \Rightarrow z \colon B}{\G, x \rel y, \Left, x \colon \square A, y \colon A \Rightarrow z \colon B}}$
%\hspace{5mm}  $\vlinf{\brlab}{$ $y$ fresh$}{\G, \Left \Rightarrow x \colon \square A}{\G, x \rel y, \Left \Rightarrow y \colon A}$
%
%\vspace{2mm}
%
%$\vlinf{\dllab}{$ $y$ fresh $}{\G, \Left, x \colon \lozenge A \Rightarrow z \colon B}{\G, x \rel y, \Left, x \colon \lozenge A, y \colon A \Rightarrow z \colon B}$
%\hspace{5mm}$\vlinf{\drlab}{}{\G, x \rel y, \Left,  \Rightarrow x \colon \lozenge A}{\G, x \rel y, \Left \Rightarrow y \colon A}$
%
%\end{center}
...
%		\vspace{3mm}
%		
%		$\vlderivation { \vlin {\sbl}{}{\G, x \rel y, \Left, x \colon \square A \Rightarrow z\colon B}{\vlhy {\G, x \rel y, \Left, x \colon \square A, y \colon A \Rightarrow z\colon B}}}$
%		\hspace{7mm}$\vlderivation { \vlin {\sbr}{y$ is fresh$}{\G, \Left \Rightarrow x \colon \square A}{\vlhy {\G, x \rel y, \Left \Rightarrow y \colon A}}}$
%		
%		\vspace{3mm}
%		
%		$\vlderivation { \vlin{\sdl}{y$ is fresh$}{\G, \Left, x \colon \lozenge A \Rightarrow z \colon B}{\vlhy {\G, x \rel y, \Left, y \colon A \Rightarrow z \colon B}}}$
%		\hspace{7mm}$\vlderivation {\vlin {\sdr}{}{\G,x \rel y, \Left \Rightarrow x \colon \lozenge A}{\vlhy {\G, x \rel y, \Left \Rightarrow y \colon A }}}$
%		
%	\end{center}
%	
...
%		\vspace{4mm}
%		
%		$\vlderivation {\vlinf{\sbl}{}{\G, \Left, x \le y, y \rel z, x \colon \square A \Rightarrow \Right}{\G,\Left, x \le y, y \rel z, x \colon \square A, z \colon A \Rightarrow \Right}}$
%		\hspace{5mm} $\vlinf{\sbr}{$ $y, z$ fresh$}{\G, \Left \Rightarrow \Right, x \colon \square A}{\G, \Left, x \le y, y \rel z \Rightarrow \Right, z \colon A}$
%		
%		
%		\vspace{4mm}
%		
%		$\vlinf{\sdl}{$ $y$ fresh $}{\G, \Left, x \colon \lozenge A \Rightarrow \Right}{\G, \Left, x \rel y, y \colon A \Rightarrow \Right}$
%		\hspace{5mm}$\vlinf{\sdr}{}{\G, \Left, x \rel y \Rightarrow \Right, x \colon \lozenge A}{\G, \Left, x \rel y \Rightarrow \Right, x \colon \lozenge A, y \colon A}$
%		
%		
%		\vspace{2mm}
%		

...
\marianela{what about the paragraph that I just added before?}
\sonia{Ok}
...
\sonia{Rewrote the last two paragraphs more succinctly.}
...
\marianela{Sonia, what do you think about mention your result of completeness with cut elimination?}
\sonia{Yes, I think the cut-elimination result should be stated; we can have it as one global result as in my notes.}

\marianela{I do not know if it is a good idea to add this but...}
\sonia{Unfortunately we don't have enough space to include the lemmas, as they are quite technical. But they should appear in the long "technical report" version of course.}

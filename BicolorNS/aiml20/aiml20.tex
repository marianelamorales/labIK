...
\marianela{I added in the first paragraph the labelled natural deduction with three cites referencing the classical case. I did that so then in the third paragraph I added the reference of Galmiche and Sahli.}
...
Structural proof theoretic accounts of modal logic can adopt the paradigm of \emph{labelled deduction} in the form of labelled natural deduction~\cite{fitting1983,prawitz1965,siemens1977} and labelled sequent systems~\cite{vigano2000,negri2005}, or the one of \emph{unlabelled deduction} in the form of e.g.~nested sequent systems~\cite{brunnler2009deep,poggiolesi2009method}. 
...
Similarly, proof systems have been designed for intuitionistic modal logic as labelled sequent systems~\cite{simpson1994}, labelled natural deduction systems~\cite{galmiche2010} and as nested sequent systems~\cite{strassburger2013,kuznets:strassburger:maehara}.
%
...
\marianela{If we want to make an specific distinction between our system and Galmiche/Sahli system I would say:
	
	In \cite{galmiche2010}, Galmiche and Salhi present label-free natural deduction systems
	for the different intuitionistic modal logics that are not using the \rn d-axiom. In this article, we present a labelled sequent calculus and a nested sequent calculus. We consider that sequent calculus is much better	suited for automated proof search than natural deduction.}
%

\marianela{I think if we write something like the thing above, it would be helpful to make the differencec between our system and the others. Let me know what you think}
...
\end{equation*}
\marianela{I think we can make clear that this part is already proven for $\labIKp$ by adding just a sentence here like below}

These extesions for $\labIKp$ are already proveṇ̣~\cite{marin:morales:strassburger:hal} but we are studying these cases for $\nIKp$.

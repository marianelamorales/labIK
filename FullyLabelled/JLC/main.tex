...
\marianela{Final version. TODO list:
	
	\begin{itemize}
		\item 
		\item"Internal cut elimination": just say "syntactic"
		\item footnote: completeness can be proved by proof search
		\item Add missing bibliography
		\item Conclusion: do not speak about "generalise" Maffezioli et al paper.
		\item References: book and thesis titles capitalized
		\item Define what provable means (Theo. 3.3)
	\end{itemize}}

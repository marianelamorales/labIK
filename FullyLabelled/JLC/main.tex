...
\begin{document}
 ...
 \begin{abstract}
   \review{Reconsider de abstract. It reads very “operational” and does not clearly state the contributions of the paper.}
   \lutz{Done?}
   ...
   %%
   We show soundness and completeness of our system, together with an internal cut elimination proof.
   %%
   Finally, we show how the system can be extended with arbitrary intuitionistic Scott-Lemmon axioms.
 \end{abstract}

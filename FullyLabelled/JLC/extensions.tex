...
\begin{itemize}
\item $\ax{4_{\BOX}} \colon \fm{\BOX A \IMP \BOX\BOX A}$
\end{itemize}
\begin{center}
$\vlderivation{
...
$
\begin{itemize}
\item $\ax{4_{\DIA}} \colon \DIA\DIA A \IMP \DIA A$:
\end{itemize}

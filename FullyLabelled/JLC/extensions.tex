...
\marianela{I made this new version since the reviewer 2 said: \emph{it does not help at all that the	applications of the rule $\rn{g1111}$ are merged with $\llabrn\BOX$ and $\rlabrn\DIA$ in the example derivation.} 

...
\subsection{Scott-Lemmon logics}
...
\begin{remark}
  ...
  %
  Below is an example derivation with a correct application of $\rn g_{1110}$ (which corresponds to Euklideaness) to derive $ \BOX(\BOX A \IMP A)$.
  	$$
		\vlderivation{
...
\todo{move this comment to the system (it also applies to boxL, F1,F2...), and then refer to it again here}

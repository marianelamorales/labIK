...
%
As we have mentioned, however, different basis can be considered for intuitionistic modal logic, for example the one called \emph{constructive modal logic} $\mathsf{CK}$~\cite{xxx} and any in between.
%

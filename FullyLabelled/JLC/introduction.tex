...
\todo{add a paragraph about constructive modal logics.} \lutz{I forgot what we agreed on here...}
...
\lutz{done in previous paragraph? can this be removed: 
\old{
...
\lutz{I've added a refence to \cite{bovzic1984models} in sec.2. But \cite{maffezioli2014} is totally unrelated, and I don't see the point in citing that}

...
\lutz{I've added a refence to \cite{bovzic1984models} in sec.2. But \cite{maffezioli2014} is totally unrelated, and I don't see the point in citing that}\todo{cite them when we indroduce F1 and F2, because they have something similar}

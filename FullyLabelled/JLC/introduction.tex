...
\marianela{The reviewer suggested to change the above sentence for the next one:
	\emph{"As done earlier in the literature  on intuitionistic modal logic (cf....) we consider here
	to enrich"} since Maffezioli, Naibo and Negri have already done this before and the next one:

	D. Garg, V. Genovese, and S. Negri, Countermodels from sequent calculi in multi-modal	logics. LICS 2012, IEEE Computer Society, pp. 315–324, 2012. (ALREADY ADDED ON REFERENCES FILE TO USE IT IF WE CHANGE THE SENTENCE: \cite{garg2012})
	What do you think about changing the sentence? We have already mentioned Maffezioli, Naibo and Negri's paper a few times...
	}
...
systems for a larger class of intuitionistic modal logics, \marianela{together

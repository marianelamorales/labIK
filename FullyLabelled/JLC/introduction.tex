...
$\Delta$ for multi-sets of labelled formulas~\cite{negri:vonplato:01}.\lutz{right ref?}
...
systems~\cite{negri:jpl2005} or nested sequents~\cite{fitting:83}\lutz{wrong ref} for

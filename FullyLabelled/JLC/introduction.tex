...
Standard labelled sequent calculi for logics with
...
$\Delta$ for multi-sets of labelled formulas~\cite{negri:vonplato:01}.
...
%	\quadcm
	...
	sequent, we only have that a formula is provable in an extension of $\IK$ beyond paths axioms 
	...
	and considered as an inelegant solution~\cite{simpson:phd}. % (see also \cite{mar:str:tableaux17}).
\end{enumerate}
...
of logics that had been treated proof-theoretically before.  
%%

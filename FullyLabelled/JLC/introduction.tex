...
\marianela{The reviewer suggested to change the above sentence for the next one:
	...
	D. Garg, V. Genovese, and S. Negri, Countermodels from sequent calculi in multi-modal	logics. LICS 2012, IEEE Computer Society, pp. 315–324, 2012. (ALREADY ADDED. SHOULD I REMOVE IT?)

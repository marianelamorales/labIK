...
exposition (see, e.g., \cite{TS:00,negri:book}). A similar system as
ours has been presented in~\cite{MNNpaper}, but as already pointed out
in~\cite{girard:book}, even a minor change in the proof system demands

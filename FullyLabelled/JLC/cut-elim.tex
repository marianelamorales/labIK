...
\begin{smallequation*}\hskip8em
	...
	{\vliin{\rn{cut}}{}
		...
		{\vlhtr{\DD_1}{\B, \accs xy, \futs yz, \futs xu, \accs uz, \Left \SEQ \Right, \labels{z}{C}}}
		{\vlhtr{\DD_2^{\rn w}[v/u]}{\B, \accs xy, \futs yz, \futs xu, \accs uz, \Left, \labels{z}{C} \SEQ \Right}}}
\end{smallequation*}
...
\begin{smallequation*}\hskip8em
	...
	\vlderibase{\rn{F_2}}{\lb u \mbox{ fresh}}{\B, \accs xy, \futs xz, \Left \SEQ \Right}{\vliin{\labrn{cut}}{}
		...
		{\vlhtr{\DD_2^{\rn w}[v/u]}{\B, \accs xy, \futs xz, \futs yu, \accs zu, \Left, \labels{z}{C} \SEQ \Right}}}
\end{smallequation*}

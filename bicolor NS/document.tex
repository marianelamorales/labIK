...
\begin{lemma}
	...
	derivation of $\Cx[1]{\Cx[2]}$
\end{lemma}

\begin{proof}
	\sonia{Need to say that the proof is by induction and what induction measure is used.}
...
\vlderivation{
	...
	{\vliin{\rn{cut}}{}
		{\Cx{\lf{A \IMP B}, \rt{A}}}
		{\vlhtr{\DD_1}{\Cx{\lf{A \IMP B}, \rt{A}, \rt{C}}}}
		{\vlhtr{\DD_3^{w}}{\Cx{\lf{A \IMP B}, \rt{A}, \lf{C}}}}}
	{\vliin{\rn{cut}}{}
		{\Cx{\lf{B}}}
		{\vlhtr{\DD_2}{\Cx{\lf{B}, \rt{C}}}}
...
\vlderivation{
	...
	{\vliin{\rn{cut}}{}
		...
		{\vlhtr{\DD_1}{\Cx{\BR{\Cx[1], \lf{A}}, \lf{\BOX A}, \rt{C}}}}
		{\vlhtr{\DD_2^{w}}{\Cx{\BR{\Cx[1], \lf{A}}, \lf{\BOX A}, \lf{C}}}}}
}
$$
...
\vlderivation{
	...
	{\vliin{\rn{cut}}{}
		...
		{\vlhtr{\DD_1}{\Cx{\BR{\Cx[1], \rt{A}}, \rt{\DIA A}, \rt{C}}}}
		{\vlhtr{\DD_2^{w}}{\Cx{\BR{\Cx[1], \rt{A}}, \rt{\DIA A}, \lf{C}}}}}
	}
$$
...
\vlderivation{
	...
	{\vliin{\rn{cut}}{}
		...
		{\vlin{\rrn\BOX}{}
			...
			{\vlhtr{\DD_1^{w}}{\Cx{\BR{\Cx[1], \lf{A}}, \bBR{\BR{\rt{A}}}}}}}
		{\vlhtr{\DD_2}{\Cx{\BR{\Cx[1], \lf{A}}, \lf{\BOX A}}}}
		}}
$$
...
\vlderivation{
	...
	{\vliin{\rn{cut}}{}
		...
		{\vlin{\lrn\DIA}{}
			...
			{\vlhtr{\DD_2^{w}}{\Cx{\BR{\Cx[1], \rt{A}}, \BR{\lf{A}}}}}}}
	{\vlin{\rn{m[]}}{}
		{\Cx{\BR{\Cx[1], \lf{A}}}}
		{\vlhtr{\DD_2}{\Cx{\BR{\Cx[1]}, \BR{\lf{A}}}}}}
	}
...
\vlderivation{
	...
	{\vliin{\rn{cut}}{}
		...
		{\vlin{\rrn\BOX}{}
			{\Cx{\rt{A}, \rt{\BOX A}}}
			{\vlhtr{\DD_1^{w}}{\Cx{\rt{A}, \bBR{\BR{\rt{A}}}}}}}
		{\vlin{\lrn[1]\BOX}{}
			{\Cx{\rt{A}, \lf{\BOX A}}}
			{\vlhtr{\DD_2^{w}}{\Cx{\rt{A}, \lf{A}}}}}}
	{\vlhtr{\DD_2}{\Cx{\lf{A}}}}
	}
$$
...
\vlderivation{
	...
	{\vlin{\lrn[2]\BOX}{}
		{\Cx{\BR{\Cx[1]}, \lf{\BOX A}}}
		{\vlhtr{\DD_2}{\Cx{\BR{\Cx[1], \lf{\BOX A}}}}}}
	}
\reducesto
$$
$$
\vlderivation{
	...
	{\vliin{\rn{cut}}{}
		...
		{\vlin{\lrn[2]\BOX}{}
			{\Cx{\BR{\Cx[1], \lf{A}}, \lf{\BOX A}}}
			{\vlhtr{\DD_2^{w}}{\Cx{\BR{\Cx[1], \lf{A}, \lf{\BOX A}}}}}}}
	}
$$

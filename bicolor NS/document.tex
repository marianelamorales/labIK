...
$$
%there must be a derivation from $R, \Gamma \SEQ \Delta}{R, \Gamma \SEQ \Delta, \labels{x_1}{A}, \ldots, \labels{x_n}{A}$ to $R, \Gamma \SEQ \Delta}{R, \Gamma \SEQ \Delta, \labels{y_1}{A}, \ldots, \labels{y_n}{A}$

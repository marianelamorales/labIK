...
\begin{lemma}
	...
	$$
	\vlderivation{
		\vliiin{\labrn{Y-cut}}{}{\Cx{\emptyset}}{
			\vlhtr{\DD_1}{\Cx{\rt{C}}^n}}{
			\vlhy{}}{
			\vlhtr{\DD_2}{\Cx{\lf{C}}^p}}}
	$$
	where $\DD_1$ and $\DD_2$ are both Y-cut-free, there is a cut-free
...
\vlderivation{
	...
	{\Cx{\emptyset}}
	{\vliin{\rrn\AND}{}
		{\Cx\i{x}{\rt{A \AND B}}{\rt{A \AND B}}^{n}}
		{\vlhtr{\DD_1}{\Cx\i{x}{\rt{A}}{\rt{A \AND B}}^{n}}}
		{\vlhtr{\DD_2}{\Cx\i{x}{\rt{B}}{\rt{A \AND B}}^{n}}}
	}
	{\vlin{\lrn\AND}{}
		{\Cx\i{y}{\lf{A \AND B}}{\lf{A \AND B}}^{p}}
		{\vlhtr{\DD_3}{\Cx\i{y}{\lf{A}, \lf{B}}{\lf{A \AND B}}^{p}}}}
	}
$$
$$
\reducesto
...
$$
\vliinf{Ycut}{}{R, \Gamma \SEQ \Delta}{R, \Gamma \SEQ \Delta, \labels{x_1}{A}, \ldots, \labels{x_n}{A}}{R, \Gamma, \labels{y_1}{A}, \ldots, \labels{y_p}{A} \SEQ \Delta}
$$

There must be a derivation from $\vlinf{}{}{R, \Gamma \SEQ \Delta}{R, \Gamma \SEQ \Delta, \labels{x_1}{A}, \ldots, \labels{x_n}{A}}$ to $\vlinf{}{}{R, \Gamma \SEQ \Delta}{R, \Gamma \SEQ \Delta, \labels{y_1}{A}, \ldots, \labels{y_n}{A}}$
...
\vlderivation{	
	\vliin{\rn{Y-cut}}{}{\Cx[1]{\BR{\bBR{\Cx[2]}}}}{
		...
		\vlin{\lrn\AND}{}{\Cx[1]{\BR{\bBR{\Cx[2], \lf {A \AND B}}}}}
		{\vlhy{\Cx[1]{\BR{\bBR{\Cx[2], \lf {A}, \lf B}}}}}
	}
}
$$
...
\quad\leadsto\quad
\vlderivation{	
\vlin{F_1}{}{\Cx[1]{\BR{\bBR{\Cx[2]}}}}{
	\vliin{\rn{Y-cut}}{}{\Cx[1]{\BR{\bBR{\Cx[2]}}, \bBR{\BR{\Gamma_2}}}}{
		\vlhy{\Cx[1]{\BR{\bBR{\Cx[2], \rt A }}, \bBR{\BR{\Cx[2], \rt A }}}}
	}{
		\vlhy{\Cx[1]{\BR{\bBR{\Cx[2], \lf A}}, \bBR{\BR{\Gamma_2}}}}
	}
}}
$$

			...
			{\vlin {\rrn\BOX}{}
				...
				{\vlin {\lrn{mon}}{}
					...
					{\vlin {\lrn\BOX}{}
						...
						{\vlin {\lrn{mon}}{}
							{\bBR{\lf{\BOX(A \IMP B)}, \bBR{\bBR{\lf{\BOX A}, \BR{\lf{A},\rt{B}}}}}}
							{\vlin {\lrn{mon}}{}
								{\bBR{\bBR{\lf{\BOX(A \IMP B)}, \bBR{\lf{\BOX A}, \BR{\lf{A},\rt{B}}}}}}
								{\vlin{\lrn\BOX}{}
									{\bBR{\bBR{\bBR{\lf{\BOX(A \IMP B)}, \lf{\BOX A},  \BR{\lf{A},\rt{B}}}}}}
									{\vliin{\lrn\IMP}{}
										{\bBR{\bBR{\bBR{\lf{\BOX(A \IMP B)}, \lf{\BOX A}, \BR{\lf{A \IMP B}, \lf{A},\rt{B}}}}}}
										{\vlin{\rn{id}}{}
											{\bBR{\bBR{\bBR{\lf{\BOX(A \IMP B)}, \lf{\BOX A}, \BR{\lf{A\IMP B}, \rt{A}, \lf{A},\rt{B}}}}}}
											{\vlhy{}}}
											{\vlin{\rn{id}}{}
												{\bBR{\bBR{\bBR{\lf{\BOX(A \IMP B)}, \lf{\BOX A}, \BR{\lf{B}, \lf{A},\rt{B}}}}}}
												{\vlhy{}}}}}}}}}}}}
	$
\end{center}
			...
			{\vlin {\lrn\DIA}
				...
				{\vlin{\rrn\DIA}
					...
					{\vlin {\lrn{mon}}
						...
						{\vlin {\lrn\BOX}
							{}
							{\bBR{\bBR{\lf{\BOX (A \IMP B)}, \BR{\lf{A}, \rt{B}}, \rt{\DIA B}}}}
							{\vliin{\lrn\IMP}
								{}
								{\bBR{\bBR{\lf{\BOX (A \IMP B)}, \BR{\lf{A \IMP B}, \lf{A}, \rt{B}}, \rt{\DIA B}}}}
								{\vlin{\rn{id}}{}
									{\bBR{\bBR{\lf{\BOX (A \IMP B)}, \BR{\lf{A\IMP B}, \rt{A}, \lf{A}, \rt{B}}, \rt{\DIA B}}}}
									{\vlhy{}}}
								{\vlin{\rn{id}}{}
									{\bBR{\bBR{\lf{\BOX (A \IMP B)}, \BR{\lf{B}, \lf{A}, \rt{B}}, \rt{\DIA B}}}}
									{\vlhy{}}}}}}}}}
	}$
\end{center}
\bigskip
					...
					{\vlin{\lrn{mon}}{}
						...
						{\vlin{\lrn{mon}}{}
							...
							{\vliin{\lrn\IMP}{}
								...
								{\vlin{\rrn\DIA}{}
									{\bBR{\bBR{\bBR{\lf{\DIA A \IMP \BOX B}, \rt{\DIA A}, \BR{\lf{A}, \rt{B}}}}}}
									{\vlin{\rn{id}}{}
										{\bBR{\bBR{\bBR{\lf{\DIA A \IMP \BOX B}, \rt{\DIA A}, \BR{ \rt{A}, \lf{A}, \rt{B}}}}}}
										{\vlhy{}}}}
								{\vlin{\lrn\BOX}{}
									{\bBR{\bBR{\bBR{\lf{\BOX B}, \BR{\lf{A}, \rt{B}}}}}}
									{\vlin{\rn{id}}{}
										{\bBR{\bBR{\bBR{\lf{\BOX B}, \BR{\lf{B}, \lf{A}, \rt{B}}}}}}
										{\vlhy{}}}}}}
						}
					}}}
	}$
...
$\vlderivation{
	...
	{\vlin{}{}
		{\Cx{\Gamma_{1}, \rt{A \IMP B}, \rt{C}}}
		{\vlhtr{\DD_1}{\Cx{\Gamma_{1}, \bBR{\lf{A}, \rt{B}}, \rt{C}}}}}
	{\vlhtr{\DD_2}{\Cx{\Gamma_{1}, \rt{A \IMP B}, \lf{C}}}} 
}$
$\reducesto$
$\vlderivation{
	\vlin{\rrn\IMP}{}
	{\Cx{\Gamma_{1}, \rt{A \IMP B}}}
	{\vliin{\rn{cut}}{}
		{\Cx{\Gamma_{1}, \bBR{\lf{A}, \rt{B}}}}
		{\vlhtr{\DD_1}{\Cx{\Gamma_{1}, \bBR{\lf{A}, \rt{B}}, \rt{C}}}}
		{\vlhtr{\DD_2^{\rrn\IMP}}{\Cx{\Gamma_{1}, \bBR{\lf{A}, \rt{B}}, \lf{C}}}}}
}$
...
$\vlderivation{
	...
	{\vliin{\lrn\IMP}{}
		{\Cx{\Gamma_{1}, \lf{A \IMP B}, \rt{C}}}
		{\vlhtr{\DD_1}{\Cx{\Gamma_{1}, \lf{A \IMP B}, \rt{A}, \rt{C}}}}
		{\vlhtr{\DD_2}{\Cx{\Gamma_{1}, \lf{B}, \rt{C}}}}}
	{\vlhtr{\DD_3}{\Cx{\Gamma_{1}, \lf{A \IMP B}, \lf{C}}}}
	}$
	$\reducesto$
...
$\vlderivation{
	...
	{\Cx{\Gamma_{1}, \lf{A \IMP B}}}
	{\vliin{\rn{cut}}{}
		{\Cx{\Gamma_{1}, \lf{A \IMP B}, \rt{A}}}
		{\vlhtr{\DD_1}{\Cx{\Gamma_{1}, \lf{A \IMP B}, \rt{A}, \rt{C}}}}
		{\vlhtr{\DD_3^{w}}{\Cx{\Gamma_{1}, \lf{A \IMP B}, \rt{A}, \lf{C}}}}}
	{\vliin{\rn{cut}}{}
		{\Cx{\Gamma_{1}, \lf{B}}}
		{\vlhtr{\DD_2}{\Cx{\Gamma_{1}, \lf{B}, \rt{C}}}}
		{\vlhtr{\DD_2^{\lrn\IMP}}{\Cx{\Gamma_{1}, \lf{B}, \lf{C}}}}}
	}$
\end{center}
...
$\vlderivation{
	...
	{\vlin{\rrn\BOX}{}
		{\Cx{\Gamma_{1}, \rt{\BOX A}, \rt{C}}}
		{\vlhtr{\DD_1}{\Cx{\Gamma_{1}, \bBR{\BR{\rt{A}}}, \rt{C}}}}}
	{\vlhtr{\DD_2}{\Cx{\Gamma_{1}, \rt{\BOX A}, \lf{C}}}}
}$
$\reducesto$
$\vlderivation{
	\vlin{\rrn\BOX}{}
	{\Cx{\Gamma_{1}, \rt{\BOX A}}}
	{\vliin{\rn{cut}}{}
		{\Cx{\Gamma_{1}, \bBR{\BR{\rt{A}}}}}
		{\vlhtr{\DD_1}{\Cx{\Gamma_{1}, \bBR{\BR{\rt{A}}}, \rt{C}}}}
		{\vlhtr{\DD_2^{\rrn\BOX}}{\Cx{\Gamma_{1}, \bBR{\BR{\rt{A}}}, \lf{C}}}}}
}$
\end{center}
...
$\vlderivation{
	...
	{\vlin{\lrn\BOX}{}
		{\Cx{\BR{\Gamma_{1}}, \lf{\BOX A}, \rt{C}}}
		{\vlhtr{\DD_1}{\Cx{\BR{\Gamma_{1}, \lf{A}}, \lf{\BOX A}, \rt{C}}}}}
	{\vlhtr{\DD_2}{\Cx{\BR{\Gamma_{1}}, \lf{\BOX A}, \lf{C}}}}
}$
$\reducesto$
$\vlderivation{
	\vlin{\lrn\BOX}{}
	...
	{\vliin{\rn{cut}}{}
		...
		{\vlhtr{\DD_1}{\Cx{\BR{\Gamma_{1}, \lf{A}}, \lf{\BOX A}, \rt{C}}}}
		{\vlhtr{\DD_2^{w}}{\Cx{\BR{\Gamma_{1}, \lf{A}}, \lf{\BOX A}, \lf{C}}}}}
}$
...
$\vlderivation{
	...
	{\vlin{\rrn\DIA}{}
		{\Cx{\BR{\Gamma_{1}}, \rt{\DIA A}, \rt{C}}}
		{\vlhtr{\DD_1}{\Cx{\BR{\Gamma_{1}, \rt{A}}, \rt{\DIA A}, \rt{C}}}}}
	{\vlhtr{\DD_2}{\Cx{\BR{\Gamma_{1}}, \rt{\DIA A}, \lf{C}}}}
	}$
	$\reducesto$
$\vlderivation{
	\vlin{\rrn\DIA}{}
	{\Cx{\BR{\Gamma_{1}}, \rt{\DIA A}}}
	{\vliin{\rn{cut}}{}
		{\Cx{\BR{\Gamma_{1}, \rt{A}}, \rt{\DIA A}}}
		{\vlhtr{\DD_1}{\Cx{\BR{\Gamma_{1}, \rt{A}}, \rt{\DIA A}, \rt{C}}}}
		{\vlhtr{\DD_2^{w}}{\Cx{\BR{\Gamma_{1}, \rt{A}}, \rt{\DIA A}, \lf{C}}}}}
	}$
...
$\vlderivation{
	\vliin{\rn{cut}}{}
	{\Cx{\Gamma_{1}, \lf{\DIA A}}}
	{\vlin{\lrn\DIA}{}
		{\Cx{\Gamma_{1}, \lf{\DIA A}, \rt{C}}}
		{\vlhtr{\DD_1}{\Cx{\Gamma_{1}, \BR{\lf{A}}, \rt{C}}}}}
	{\vlhtr{\DD_2}{\Cx{\Gamma_{1}, \lf{\DIA A}, \rt{C}}}}
	}$
	$\reducesto$
$\vlderivation{
	\vlin{\lrn\DIA}{}
	...
	{\vliin{\rn{cut}}{}
		{\Cx{\Gamma_{1}, \BR{\lf{A}}}}
		{\vlhtr{\DD_1}{\Cx{\Gamma_{1}, \BR{\lf{A}}, \rt{C}}}}
		{\vlhtr{\DD_2^{\lrn\DIA}}{\Cx{\Gamma_{1}, \BR{\lf{A}}, \lf{C}}}}}
	}$
\end{itemize}

\textbf{Key cases}: In the case when the last rule in $\DD_1$ and in $\DD_2$ applies to the cut-formula, it is the complexity of the cut-formula that is the decresing inductive measure.
...
$\vlderivation{
	...
	{\vliin{}{}
		{\Cx{\Gamma_{1}, \rt{A}}}
		{\vlhtr{\DD_1}{\Cx{\Gamma_{1}, \rt{A}, \rt{B}}}}
		{\vlhtr{\DD_3^{w}}{\Cx{\Gamma_{1}, \rt{A}, \lf{B}}}}}
	{\vlhtr{\DD_2}{\Cx{\Gamma_{1}, \lf{A}}}}
	}$	
...
$\vlderivation{
	...
	{\vliin{\lrn\IMP}{}
		{\Cx{\Gamma_{1}, \lf{A \IMP B}}}
		{\vlhtr{\DD_2}{\Cx{\Gamma_{1}, \lf{A \IMP B}, \rt{A}}}}
		{\vlhtr{\DD_3}{\Cx{\Gamma_{1}, \lf{B}}}}}}$
	$\reducesto$
...
$\vlderivation{
	...
	{\vliin{\rn{cut}}{}
		{\Cx{\Gamma_{1}, \rt{A}}}
		{\vlin{\rrn\IMP}{}
			{\Cx{\Gamma_{1}, \rt{A}, \rt{A \IMP B}}}
			{\vlhtr{\DD_1^{w}}{\Cx{\Gamma_{1}, \rt{A}, \bBR{\lf{A}, \rt{B}}}}}}
		{\vlhtr{\DD_2}{\Cx{\Gamma_{1}, \rt{A}, \lf{A \IMP B}}}}}
	{\vliin{\rn{cut}}{}
		{\Cx{\Gamma_{1}, \lf{A}}}
...
$\vlderivation{
	...
	{\vlin{\lrn\BOX}{}
		{\Cx{\BR{\Gamma_{1}}, \lf{\BOX A}}}
		{\vlhtr{\DD_2}{\Cx{\BR{\Gamma_{1}, \lf{A}}, \lf{\BOX A}}}}}
}$
$\reducesto$

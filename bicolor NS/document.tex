...
\marianela{Not sure. Is not there a rule like if I have something like $\BR{\BR{}}$, then I can have only one bracket? Or the medial but swapping the premise and conclusion? HAVING SIMILAR PROBLEM FOR THE KEY CASE OF $\lrn[2]\BOX$}
...
\vlderivation{
	...
	{\vlin{\rn{m[]}}{}
		...
		{\vlin{\rrn\BOX}{}
			...
			{\vlhtr{\DD_1^{\rn w}}{\Cx{\BR{\Cx[1]}, \BR{\bBR{\BR{\rt{A}}}}}}}}}
	{\vliin{\rn{cut}}{}
		{\Cx{\BR{\Cx[1], \lf{\BOX A}}}}
		{\vlin{}{}

...
\sonia{well... as always, the devil is in the details. Check out this case in the proof of Lemma~\ref{lem:weak-adm}:
\[
\vlderivation{
	\vlin{\rn{w}}{}{\Cx[1]{\BR{\Cx[2], \bBR{\Cx[3]}}}}{
		\vlin{\rn{F_1}}{}{\Cx[1]{\BR{\bBR{\Cx[3]}}}}{
			\vlhtr{}{\Cx[1]{\BR{\bBR{\Cx[3]}}, \bBR{{\BR{\Cx[3]}}}}}
			}
		}
	}
\]
...
\vlderivation{
	\vlin{\rn{F_1}}{}{\Cx[1]{\BR{\Cx[2], \bBR{\Cx[3]}}}}{
		\vlin{\rn{w}}{}{\Cx[1]{\BR{\Cx[2], \bBR{\Cx[3]}}, \bBR{{\BR{\Cx[3]}}}}}{
			\vlhtr{}{\Cx[1]{\BR{\bBR{\Cx[3]}}, \bBR{{\BR{\Cx[3]}}}}}
			}
		}
	}
...
\sonia{I am wondering however, if it would remain complete if we had:
\[
...
\item $\lrn{mon}$ when applied in $\Cx$:
...
\vlderivation{
	...
	{\Cx{\lf{A}, \bBR{\Cx[1]}}{\emptyset}}
	{\vliin{\rn{cut}}{}
		{\Cx{\lf{A}, \bBR{\lf{A}, \Cx[1]}}{\emptyset}}
		{\vlhtr{\DD_1}{\Cx{\lf{A}, \bBR{\lf{A}, \Cx[1]}}{\rt{C}}}}
		{\vlhtr{\DD_2^{\rn w}}{\Cx{\lf{A}, \bBR{\lf{A}, \Cx[1]}}{\lf{C}}}}}
}
$$
